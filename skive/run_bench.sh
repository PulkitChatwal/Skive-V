...
echo "### FullKV ###"
python stage6/benchmark.py $COMMON
echo "### evict budget=20 (~80%) ###"
python stage6/benchmark.py $COMMON --evict --budget 20 --sink 2 --local 4
echo "### evict budget=13 (~50%) ###"
python stage6/benchmark.py $COMMON --evict --budget 13 --sink 2 --local 4
echo "### evict budget=8 (~32%) ###"
python stage6/benchmark.py $COMMON --evict --budget 8 --sink 2 --local 4
echo "BENCH_DONE"
